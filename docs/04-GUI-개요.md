...
![OpenSim GUI 레이아웃](images/gui-layout.png)

*그림 4-1. OpenSim GUI 주요 영역 — Arm26 모델이 로드된 상태의 모형도. 좌측 Navigator,
중앙 3D Visualizer, 우측 Coordinates 슬라이더, 하단 Messages 콘솔로 구성된다.*

| 영역 | 설명 |
| ---- | ---- |
| ① 메뉴바 | File · Edit · View · Tools · Window · Help |
| ② 툴바 | 재생 컨트롤(▶ ◼) · 도구 바로가기(Scale/IK/ID...) · 카메라 |
| ③ Navigator | 모델 트리 (Bodies, Joints, Forces, Markers...) |
| ④ 3D Visualizer | 모델·마커·외력 시각화 |
| ⑤ Coordinates | 자유도별 슬라이더, Lock/Reset 컨트롤 |
| ⑥ Messages | 로그·경고·도구 진행 상황 출력 |
